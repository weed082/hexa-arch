...
type Message struct {
	...
	RoomIdx int32  `protobuf:"varint,1,opt,name=room_idx,json=roomIdx,proto3" json:"room_idx,omitempty"`
...
func (x *Message) GetRoomIdx() int32 {
	if x != nil {
		return x.RoomIdx
	}
	return 0
...
func (x *Message) GetUserIdx() int32 {
	if x != nil {
		return x.UserIdx
	}
	return 0
...
var file_chat_proto_rawDesc = []byte{
	...
	,
	...
	0x01, 0x42, 0x09, 0x5a, 0x07, 0x2e, 0x2e, 0x2f, 0x63, 0x68, 0x61, 0x74, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_chat_proto_depIdxs = []int32{
	0, // 0: chat.ChatService.ChatService:input_type -> chat.Message
	0, // 1: chat.ChatService.ChatService:output_type -> chat.Message
...
func (x *chatServiceChatServiceClient) Send(m *Message) error {
	return x.ClientStream.SendMsg(m)
}

func (x *chatServiceChatServiceClient) Recv() (*Message, error) {
	m := new(Message)
...
func (x *chatServiceChatServiceServer) Send(m *Message) error {
	return x.ServerStream.SendMsg(m)
}

func (x *chatServiceChatServiceServer) Recv() (*Message, error) {
	m := new(Message)
